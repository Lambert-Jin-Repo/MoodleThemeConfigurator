...
const TIMELINE = [
  { title: 'Module 3 Quiz', type: 'Quiz', purpose: 'assessment' as const },
  { title: 'Accessibility Audit Report', type: 'Assignment', purpose: 'assessment' as const },
  { title: 'Discussion: Inclusive Design', type: 'Forum', purpose: 'communication' as const },
];
