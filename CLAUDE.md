...
- **Current branch (ready for PR):** `worktree-fix+dark-theme-enrolment-icons`, off `main` (`f52e845`, after PR #21) — course-listing enrolment-method icons (#138). User-verified on Moodle Cloud; dark presets only; no new tokens, presets, or controls. See the #138 bullet below + `docs/PROJECT-TRACKER.md`. (Footer "Show footer" help-button `?` icon (#139) may be added to this branch — in progress.)
