...
- **Current branch (ready for PR):** `worktree-fix+dark-theme-quiz-radio-contrast`, off `main` (`dbcaa0f`) — 3 commits, one combined "dark-theme contrast" PR: quiz answer-radio selection (#133), tooltip text (#134), icon-button hover (#135). All user-verified on Moodle Cloud; dark presets only; no new tokens, presets, or controls. See the #133–#135 bullets below + `docs/PROJECT-TRACKER.md`.
