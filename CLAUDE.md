...
- **Current branch (ready for PR):** `worktree-fix+dark-theme-enrolment-icons`, off `main` (`f52e845`, after PR #21) — course-listing enrolment-method icons (#138), footer "Show footer" help-button `?` icon (#139), and the Messaging drawer full dark surface (#140). All user-verified on Moodle Cloud; dark presets only; no new tokens, presets, or controls. See the #138 / #139 / #140 bullets below + `docs/PROJECT-TRACKER.md`.
